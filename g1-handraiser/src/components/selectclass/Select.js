...
const ClassComponent = ({res, i, verify, bannerArray}) => {
  const { Meta } = Card;
  const [banner, setBanner] = useState('https://image.freepik.com/free-vector/office-workplace-illustration_24908-58535.jpg');
        ...
        <Card
          ...
          cover={
            <div>
              ...
              <img alt={i} src={banner} style={{height: 150, width: 300}} />
            </div>}
